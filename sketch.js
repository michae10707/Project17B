...
player1  = createSprite(170,150);
player1.addAnimation("SahilRunning",oppPink1Img);
player1.scale=0.07;

player2  = createSprite(170,150);
player2.addAnimation("SahilRunning",oppYellow1Img);
player2.scale=0.07;

player3  = createSprite(170,150);
player3.addAnimation("SahilRunning",oppRed1Img);
player3.scale=0.07;
...
function draw() {
  ...
  if(path.x < 0 ){
   ...
   text("Press Up Arrow to Restart the game! ", 650,300); 
  }
...
function reset(){
  gameState = PLAY;
  //To hide gameover sprite
  gameOver.visible=false; 
  // to hide restart sprite
 ...
 // To reset score
 distance=0;
 // to change the maincyclist animation
